# Copied from https://gist.github.com/tredfern0/796f5d9c415f8a429fdc4e3a2334257f
# Runs faster per game than mine
...
def problem2(inp, print_=False):
    ...
    while not score:
        damage_dict["E"] += 1
        print("Atk",damage_dict["E"])
        score = problem2_loop(inp, damage_dict, print_)
    return score

if __name__=="__main__":
    with open("q15.in","r") as f:
        data = f.read().strip()
